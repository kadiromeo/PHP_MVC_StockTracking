...
<script>
    $(document).ready(function () {
        ...
        $("#yeniEkle").click(function () {
            var temp ='<div class="col-md-6"><label>Ürün Özellik Adı:</label><input  type="text" class="form-control selectOzellik" name="ozellikler['+i+'][name]"></div>' +
                '<div class="col-md-6"><label>Ürün Özellik Degeri:</label><input type="text" class="form-control" name="ozellikler['+i+'][value]"></div>';
